...
import org.jared.jaredctienda.domain.Producto;
...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
    ...
    //PRACTICA 2, consultas x existencia usando derivadas
    public List<Producto> findByExistenciasBetweenOrderByExistenciasAsc(int existenciasInf, int existenciasSup);
